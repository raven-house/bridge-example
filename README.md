...
Example scripts demonstrating how to use the `@ravenhouse/bridge-sdk` package for bridging tokens between Ethereum L1 and Aztec L2.
...
2. Connects to Aztec node and sets up L2 wallet
3. Burns tokens on L2 and waits for proof generation
